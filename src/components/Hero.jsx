...
const Hero = () => {
  return (
    <>
    <div className="container mx-auto px-6 py-8 bg-[linear-gradient(to_right,#8080800a_1px,transparent_1px),linear-gradient(to_bottom,#8080800a_1px,transparent_1px)] bg-[size:14px_24px] relative">
      {/* Fixed position for the gradient background */}
